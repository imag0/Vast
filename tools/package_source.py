"""Create a deterministic Vast 3.2.19 source bundle without signing secrets."""
...
OUTPUT = ROOT / "dist" / "Vast-v3.2.19-source.zip"
PREFIX = "Vast-v3.2.19-source/"
...
INCLUDED_TOP_LEVEL_FILES = {
    "RELEASE_3.2.19.md", "RELEASE_3.2.18.md", "RELEASE_3.2.17.md", "RELEASE_3.2.16.md", "RELEASE_3.2.14.md", "UI_REVIEW_3.2.14.md",
